        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="flex items-center space-x-4">
            <Link
              ...
              className="hidden sm:inline-flex items-center px-6 py-2.5 bg-primary text-white font-montserrat font-semibold rounded-lg hover:bg-primary-dark hover:shadow-hover hover:-translate-y-0.5 transition-all duration-300"
            >
            ...
            <button
              onClick={toggleMenu}
              className="lg:hidden p-2 rounded-lg text-secondary hover:text-primary hover:bg-accent transition-all duration-300"
